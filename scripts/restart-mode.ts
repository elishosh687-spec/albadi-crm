...
const GROUP_TEMPLATES: Record<GroupKey, { title: string; template: string; action: string }> = {
  ...
  quote_sent_followup: {
    ...
    template:
      "היי {name}, אלי מאלבדי — אריזות בהתאמה אישית. 🎒\n" +
      "\n" +
      "שלחתי לך לפני כחודש הצעת מחיר ({quoteTotal} ש\"ח) ומאז לא חזרתי אליך — סליחה. היו אצלי כמה התעסקויות שעיכבו אותי וזה לא היה הוגן כלפיך.\n" +
      "\n" +
      "ההצעה עדיין בתוקף, ואני שמח לחזור איתך לתהליך אם זה עוד מעניין אותך.\n" +
      "\n" +
      "אם זה לא רלוונטי כרגע — גם זו תשובה לגיטימית, פשוט תכתוב לי ולא אטריד.",
    action: "שלח טמפלייט. אם עונה → סווג מחדש לפי תשובה. אם 5+ ימים שקט → לא_ענה.",
  },
  after_holiday: {
    title: "🕯️ \"אחרי החג\"",
    template:
      "היי {name}, אלי מאלבדי — מקווה שהיו לך חגים שמחים. 🌿\n" +
      "\n" +
      "דיברנו לפני החגים ואמרת שנחזור לדבר אחרי. החגים מאחורינו, אבל אני זה שאיחר לחזור הפעם — סליחה.\n" +
      "\n" +
      "האם הנושא של האריזות עדיין רלוונטי בשבילך? אשמח להתקדם או לעדכן את ההצעה אם השתנה משהו.",
  ...
  said_too_expensive: {
    ...
    template:
      "היי {name}, אלי מאלבדי. 🎒\n" +
      "\n" +
      "כשדיברנו אמרת שההצעה הייתה גבוהה מדי בשבילך — אני שומע ומבין. חזרתי לחשוב על זה ויש כמה דרכים שאפשר להוריד את העלות בלי לפגוע באיכות (התאמת כמות, מספר צבעים, סוג חומר).\n" +
      "\n" +
      "אם עוד יש לך עניין — אשמח לעבור איתך על האפשרויות בשיחה קצרה ולמצוא משהו שמתאים לתקציב שלך.",
  ...
  requested_call_no_answer: {
    ...
    template:
      "היי {name}, אלי מאלבדי — אריזות בהתאמה אישית. 🎒\n" +
      "\n" +
      "ביקשת שאחזור אליך לתאם שיחה ואני פשוט לא חזרתי בזמן — סליחה אמיתית, היו אצלי דברים שעיכבו אבל זה לא תירוץ מולך.\n" +
      "\n" +
      "אם זה עדיין רלוונטי — תכתוב לי איזה זמן הכי נוח לך השבוע, ואני אתקשר. בלי לחץ ובלי התחייבות.",
    action: "שלח טמפלייט. כשעונה — אלי מתקשר.",
  },
  questionnaire_incomplete: {
    title: "📝 שאלון לא הושלם",
    template:
      "היי {name}, אלי מאלבדי כאן. 🎒\n" +
      "\n" +
      "ראיתי שהתחלת אצלנו תהליך לבדיקת אריזות מותאמות לעסק שלך אבל לא סיימת — אולי שכחת, ואולי משהו לא היה ברור.\n" +
      "\n" +
      "אם זה עדיין רלוונטי, השלמה לוקחת דקה ובסוף אתה מקבל הצעת מחיר ראשונית. רוצה שנמשיך מאיפה שעצרת?",
  ...
  already_marked_no_answer: {
    ...
    template:
      "היי {name}, אלי מאלבדי.\n" +
      "\n" +
      "ניסיתי לחזור אליך לפני זמן ולא הצלחתי לתפוס אותך — אני יודע שזה כנראה לא היה זמן טוב.\n" +
      "\n" +
      "אם בעתיד תצטרך אריזות מותאמות אישית — אני כאן ושמח לעזור. אם זה לא רלוונטי בכלל — תכתוב לי, ואני לא אטריד יותר. תודה על הזמן שלך.",
