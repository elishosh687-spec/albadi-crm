// Pure constants — no env reads, no throws. Safe for both server and
// client bundles, and for the bridge implementation which still wants
// the same numeric ids for backward compat (so existing call sites that
// pass numeric tag ids keep working unchanged).
