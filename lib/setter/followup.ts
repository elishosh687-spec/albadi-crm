...
const STAGE_INTENT: Record<string, string> = {
  ...
  FUTURE_FOLLOW_UP:
    "ליד שצונן ונשמר לשלב 'להתקשר בעתיד'. המטרה היחידה: לקבוע שיחת טלפון בזמן " +
    "קונקרטי — לא תשובה, לא מכירה מחדש. עגן במה שכבר נשלח, אל תתנצל על השתיקה, " +
    "והצע שעה אחת מוגדרת. שאלה אחת לכל היותר.",
};
