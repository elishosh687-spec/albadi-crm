...
export const BOT_SETTING_FIELDS: BotSettingField[] = [
  ...
  },
  {
    ...
    description:
      "גם שאלה שהוסרה. כבוי = בלי למינציה, המחיר הזול יותר. הבוט מציע עד 3 צבעים, אז ההגדרה הזו קובעת תמיד. (במחשבונים הידניים 4 צבעים ומעלה מסמנים למינציה כברירת מחדל — אפשר לבטל.)",
    where: "מוזן לפני מסך האישור",
    type: "toggle",
  },
