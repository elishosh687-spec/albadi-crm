...
// LAMINATION FIX (2026-06-24): laminationPrices["3000"] used to hold the SEWING
// (车缝) price while 5000/10000 were heat-press (热压) — a method-mix that made
// the 3000 customer total cost MORE than 5000 (the "big drop"). Re-pulled the
// consistent heat-press 3000 price from the Feishu catalog (one tab per size)
// for p2..p9 and p13; their 5000/10000 already matched. p1's 5000/10000 still
// differ from Feishu (the open D8-vs-D9 question) so only its 3000 was de-mixed.
// p12 (H10*W15) has no heat-press lamination in the sheet (sewing only) — kept.
const DEFAULT_PRODUCTS: Product[] = [
  {
    id: "p1", dimensions: "H20*D8*W25", description: "מתאים לקוסמטיקה, תכשיטים, אקססוריז", sortOrder: 1,
    laminationColorPlateFee: 300,
    withHandles: { prices: { "1000": 1.3, "3000": 0.78, "5000": 0.6, "10000": 0.5 }, carton: { qty: 250, weight: 5.5, length: 40, width: 24, height: 48 }, laminationPrices: { "1000": 2.3, "3000": 0.82, "5000": 0.7, "10000": 0.55 } },
    withoutHandles: { prices: { "1000": 1.25, "3000": 0.72, "5000": 0.55, "10000": 0.45 }, carton: { qty: 250, weight: 4, length: 30, width: 24, height: 48 }, laminationPrices: { "1000": 2.2, "3000": 0.78, "5000": 0.65, "10000": 0.54 } },
  },
  {
    id: "p2", dimensions: "H30*D10*W30", description: "מתאים לביגוד קל, מתנות", sortOrder: 2,
    laminationColorPlateFee: 290,
    withHandles: { prices: { "1000": 1.4, "3000": 0.89, "5000": 0.65, "10000": 0.6 }, carton: { qty: 250, weight: 8, length: 45, width: 34, height: 48 }, laminationPrices: { "1000": 2.4, "3000": 1.15, "5000": 0.69, "10000": 0.67 } },
    withoutHandles: { prices: { "1000": 1.36, "3000": 0.84, "5000": 0.63, "10000": 0.58 }, carton: { qty: 250, weight: 7, length: 34, width: 34, height: 48 }, laminationPrices: { "1000": 2.3, "3000": 1.12, "5000": 0.67, "10000": 0.65 } },
  },
  {
    id: "p3", dimensions: "H30*D12*W40", description: "מתאים לנעליים, ביגוד, קופסאות", sortOrder: 3,
    laminationColorPlateFee: 390,
    withHandles: { prices: { "1000": 1.4, "3000": 0.97, "5000": 0.78, "10000": 0.72 }, carton: { qty: 250, weight: 10, length: 45, width: 45, height: 48 }, laminationPrices: { "1000": 2.45, "3000": 1.42, "5000": 0.85, "10000": 0.83 } },
    withoutHandles: { prices: { "1000": 1.36, "3000": 0.92, "5000": 0.76, "10000": 0.67 }, carton: { qty: 250, weight: 9, length: 45, width: 35, height: 48 }, laminationPrices: { "1000": 2.39, "3000": 1.38, "5000": 0.83, "10000": 0.81 } },
  },
  {
    id: "p4", dimensions: "H40*D15*W50", description: "מתאים לפריטים גדולים", sortOrder: 4,
    laminationColorPlateFee: 615,
    withHandles: { prices: { "1000": 2.1, "3000": 1.3, "5000": 1.05, "10000": 1 }, carton: { qty: 200, weight: 12, length: 65, width: 45, height: 40 }, laminationPrices: { "1000": 3.1, "3000": 2.12, "5000": 1.27, "10000": 1.25 } },
    withoutHandles: { prices: { "1000": 2.04, "3000": 1.24, "5000": 1.03, "10000": 0.98 }, carton: { qty: 200, weight: 11.5, length: 55, width: 44, height: 40 }, laminationPrices: { "1000": 2.9, "3000": 2.09, "5000": 1.25, "10000": 1.18 } },
  },
  {
    id: "p5", dimensions: "H30*W40", description: "מתאים לפריטים רחבים", sortOrder: 5,
    laminationColorPlateFee: 300,
    withHandles: { prices: { "1000": 1.4, "3000": 0.76, "5000": 0.6, "10000": 0.51 }, carton: { qty: 500, weight: 13, length: 55, width: 34, height: 50 }, laminationPrices: { "1000": 2.2, "3000": 1.1, "5000": 0.66, "10000": 0.59 } },
    withoutHandles: { prices: { "1000": 1.35, "3000": 0.7, "5000": 0.55, "10000": 0.46 }, carton: { qty: 500, weight: 11, length: 44, width: 34, height: 50 }, laminationPrices: { "1000": 2, "3000": 1, "5000": 0.6, "10000": 0.54 } },
  },
  {
    id: "p6", dimensions: "H15*W20", description: "מתאים לפריטים קטנים", sortOrder: 6,
    laminationColorPlateFee: 300,
    withHandles: { prices: { "1000": 1.3, "3000": 0.58, "5000": 0.41, "10000": 0.33 }, carton: { qty: 500, weight: 6, length: 30, width: 25, height: 50 }, laminationPrices: { "1000": 2.02, "3000": 0.82, "5000": 0.49, "10000": 0.35 } },
    withoutHandles: { prices: { "1000": 1.2, "3000": 0.53, "5000": 0.55, "10000": 0.37 }, carton: { qty: 500, weight: 4, length: 24, width: 20, height: 50 }, laminationPrices: { "1000": 1.98, "3000": 0.77, "5000": 0.46, "10000": 0.32 } },
  },
  {
    id: "p7", dimensions: "H15*D5*W20", description: "תיק קטן צר — מתאים למוצרי יוקרה", sortOrder: 7,
    laminationColorPlateFee: 300,
    withHandles: { prices: { "1000": 1.35, "3000": 0.7, "5000": 0.52, "10000": 0.4 }, carton: { qty: 500, weight: 7, length: 36, width: 36, height: 48 }, laminationPrices: { "1000": 2.23, "3000": 1.12, "5000": 0.67, "10000": 0.59 } },
    withoutHandles: { prices: { "1000": 1.3, "3000": 0.66, "5000": 0.5, "10000": 0.4 }, carton: { qty: 500, weight: 5.2, length: 36, width: 25, height: 48 }, laminationPrices: { "1000": 2.15, "3000": 1.04, "5000": 0.62, "10000": 0.55 } },
  },
  {
    id: "p8", dimensions: "H35*D10*W40", description: "תיק בינוני-גדול — מתאים לביגוד וקופסאות", sortOrder: 8,
    laminationColorPlateFee: 405,
    withHandles: { prices: { "1000": 1.7, "3000": 1.06, "5000": 0.8, "10000": 0.75 }, carton: { qty: 250, weight: 11, length: 55, width: 40, height: 50 }, laminationPrices: { "1000": 2.7, "3000": 1.49, "5000": 0.89, "10000": 0.87 } },
    withoutHandles: { prices: { "1000": 1.65, "3000": 0.92, "5000": 0.77, "10000": 0.67 }, carton: { qty: 250, weight: 10, length: 44, width: 40, height: 48 }, laminationPrices: { "1000": 2.6, "3000": 1.45, "5000": 0.87, "10000": 0.85 } },
  },
  {
    id: "p9", dimensions: "H40*D15*W45", description: "תיק גדול — מתאים לאריזות מתנה גדולות", sortOrder: 9,
    laminationColorPlateFee: 570,
    withHandles: { prices: { "1000": 1.88, "3000": 1.29, "5000": 1, "10000": 0.95 }, carton: { qty: 250, weight: 14.5, length: 55, width: 49, height: 50 }, laminationPrices: { "1000": 2.8, "3000": 2, "5000": 1.2, "10000": 1.18 } },
    withoutHandles: { prices: { "1000": 1.82, "3000": 1.11, "5000": 0.97, "10000": 0.87 }, carton: { qty: 250, weight: 13.2, length: 50, width: 44, height: 48 }, laminationPrices: { "1000": 2.75, "3000": 1.97, "5000": 1.18, "10000": 1.14 } },
  },
  {
  ...
  },
  {
    ...
    laminationColorPlateFee: 300,
    withHandles: { prices: { "1000": 1.37, "3000": 0.67, "5000": 0.63, "10000": 0.6 }, carton: { qty: 500, weight: 9, length: 40, width: 30, height: 45 }, laminationPrices: { "1000": 2.17, "3000": 1.09, "5000": 0.65, "10000": 0.61 } },
    withoutHandles: { prices: { "1000": 1.32, "3000": 0.63, "5000": 0.59, "10000": 0.56 }, carton: { qty: 500, weight: 8, length: 30, width: 30, height: 45 }, laminationPrices: { "1000": 2.12, "3000": 1, "5000": 0.6, "10000": 0.57 } },
  },
];
