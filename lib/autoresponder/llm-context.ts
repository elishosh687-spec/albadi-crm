...
מינימום להזמנה אוטומטית: 3,000 יחידות; כמות נמוכה יותר עוברת לנציג
זמן אספקה ברירת מחדל: משלוח ימי, 60–90 ימים מאישור הגרפיקה הסופית
בקשת אקספרס / אווירי / משלוח מהיר: לא מבטיחים זמן ולא מציגים מחיר אוטומטי; מעבירים לנציג לבדיקת מסלול אווירי או משולב
תשלום: 50% בעת ההזמנה, 50% לפני יציאת הסחורה מהמפעל
מטבע: ILS
המחיר כולל: ייצור + הדפסה + משלוח לארץ; אינו כולל מע"מ`;
