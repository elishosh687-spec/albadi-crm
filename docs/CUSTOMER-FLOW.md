...
| 4 | `WAITING_FACTORY` | "אחר" בשאלון / calc API נכשל | אלי שולח מחיר ידני | בוט נכנס, אלי יוצא |
| 5 | `AWAITING_FINAL` | אלי שלח מחיר סופי (אחרי לוגו או אחרי factory) | הסכמה → WON / דחייה / מיקוח | בוט |
...
| Flag | משמעות |
|---|---|
| `NEEDS_ELI` | דורש טיפול ידני של אלי. הוצב על ידי הבוט בכל escalation. |
| `bot_paused` | הבוט לא ישלח שום דבר ללקוח. מוסר אוטומטית כשהלקוח שולח הודעה חדשה. |
