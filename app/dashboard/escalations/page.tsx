  ...
  const [open, closed] = await Promise.all([
    db
      .select({
        ...
        suggestedTag: escalations.suggestedTag,
        suggestedTagReason: escalations.suggestedTagReason,
        tagAppliedAt: escalations.tagAppliedAt,
            ...
            return (
              <EscalationCard
                ...
                escalation={{
                  ...
                  suggestedTag: e.suggestedTag ?? null,
                  suggestedTagReason: e.suggestedTagReason ?? null,
                  tagAppliedAt: e.tagAppliedAt ? e.tagAppliedAt.toISOString() : null,
                  context: {
