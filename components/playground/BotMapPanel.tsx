  ...
  return (
    <div style={{ maxWidth: 720 }}>
      ...
      <Phase n="4" title="אחרי ההצעה">
        <Locked text="כ-27 תשובות מוכנות — כולל זמני אספקה (25/90 יום) ותנאי תשלום (50/50)" />
        <Meta
          text={
            S.setterLiveEnabled
              ? "מוח המכירות מחליף חלק מהן בתשובה שנכתבת בזמן אמת"
              : "מוח המכירות כבוי — כל התשובות הן הקבועות"
          }
        />
      </Phase>
      ...
      <Phase n="5" title="תזכורות">
        ...
        <Locked text="נוסח 13 התזכורות עצמן" />
      </Phase>
      ...
      <div style={{ ...card, marginBottom: 30 }}>
        <Row k="נוסח 13 התזכורות" v="הכי נשלחות, ועדיין לא ניתנות לעריכה" />
